    ...
    function (logger, dataContext,helpers) {
        ...
        function buildSummary(records) {
            ...
            for (var i = 0; i < records().length; i++) {
                var percValue = calculatePercentage(records()[i].totalCallCost);
                compList.push({ companyName: records()[i].companyName, totalCost: records()[i].displayTotalCallCost, percentage: percValue + "%" });
